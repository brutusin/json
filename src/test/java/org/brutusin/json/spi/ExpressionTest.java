...
public abstract class ExpressionTest {
    ...
    protected abstract JsonNode getJsonNode() throws ParseException;

    protected abstract JsonSchema getJsonSchema() throws ParseException;

    protected abstract String[] getExpressions();

    protected abstract String[] getInvalidExpressions();
